...
import com.example.poyectllamasoft.R;

import java.util.ArrayList;

public class ListarFactura extends RecyclerView.Adapter<com.example.poyectllamasoft.Clases.ListarFactura.ViewHolderDatos> {
